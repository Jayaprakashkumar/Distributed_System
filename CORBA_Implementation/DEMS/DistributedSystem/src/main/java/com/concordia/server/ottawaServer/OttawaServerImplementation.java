...
public class OttawaServerImplementation extends ClientIDLInterfacePOA implements Runnable{
...
//					
//					String outStr  = MtlServer.BookEvent(splitRecievedStr[0], splitRecievedStr[1], splitRecievedStr[2]);
